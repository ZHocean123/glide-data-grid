import { h } from "vue";
import BubblesOverlayEditor from "../internal/data-grid-overlay-editor/private/BubblesOverlayEditor.vue";
...
// Vue component for bubble cell overlay editor
const BubbleOverlayEditor = {
    name: "BubbleOverlayEditor",
    props: {
        bubbles: {
            type: Array,
            default: () => []
...
export const bubbleCellRenderer: InternalCellRenderer<BubbleCell> = {
    ...
    provideEditor: () => {
        return {
            editor: (props: any) => {
                return h(BubbleOverlayEditor, {
                    bubbles: props.value.data
                });
            }
        };
    },
