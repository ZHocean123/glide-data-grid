import { h } from "vue";
import DrilldownOverlayEditor from "../internal/data-grid-overlay-editor/private/DrilldownOverlayEditor.vue";
import {
    getEmHeight,
    getMiddleCenterBias,
    measureTextCached,
...
// Vue component for drilldown cell overlay editor
const DrilldownOverlayEditorComponent = {
    name: "DrilldownOverlayEditorComponent",
    props: {
        drilldowns: {
            type: Array,
            default: () => []
    ...
    setup(props: any) {
        return () => h(DrilldownOverlayEditor, {
...
export const drilldownCellRenderer: InternalCellRenderer<DrilldownCell> = {
    ...
    provideEditor: () => {
        return {
            editor: (props: any) => {
                return h(DrilldownOverlayEditorComponent, {
                    drilldowns: props.value.data
                });
            }
        };
    },
