import { h } from 'vue';
import DrilldownOverlayEditor from '../internal/data-grid-overlay-editor/private/drilldown-overlay-editor.vue';
import {
    getEmHeight,
    getMiddleCenterBias,
    measureTextCached,
...
export const drilldownCellRenderer: InternalCellRenderer<DrilldownCell> = {
    ...
    provideEditor: () => p => {
        const { value } = p;
        return h(DrilldownOverlayEditor, { drilldowns: value.data });
    },
    onPaste: () => undefined,
};
