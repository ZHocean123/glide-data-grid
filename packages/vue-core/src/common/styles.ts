...
export function makeCSSStyle(theme: Theme): Record<string, string> {
    return {
        ...
        "--gdg-bg-cell-selected": theme.bgCellSelected || '#e9e9eb',
        "--gdg-bg-cell-disabled": theme.bgCellDisabled || '#f5f5f7',
        "--gdg-bg-gray": theme.bgGray || '#dddddd',
...
const dataEditorBaseTheme: Theme = {
    ...
    bgCell: "#FFFFFF",
    bgCellMedium: "#FAFAFB",
    bgCellSelected: "#e9e9eb",
    bgCellDisabled: "#f5f5f7",
    bgGray: "#dddddd",
    bgHeader: "#F7F7F8",
