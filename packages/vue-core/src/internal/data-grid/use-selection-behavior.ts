...
export function useSelectionBehavior(
    ...
    const setSelectedRows = (newRows: CompactSelection | undefined, append: Slice | number | undefined, allowMixed: boolean): void => {
    ...
    const setSelectedColumns = (newCols: CompactSelection | undefined, append: number | Slice | undefined, allowMixed: boolean): void => {
