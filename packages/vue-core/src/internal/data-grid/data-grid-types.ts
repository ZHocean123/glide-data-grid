...
/** @category Types */
export type ImageEditorType = any; // Vue component type will be defined later
...
export interface BaseGridCell {
    ...
    readonly cursor?: string; // Changed from CSSProperties["cursor"] to string
...
/** @category Renderers */
export type ProvideEditorComponent<T extends InnerGridCell> = any; // Vue component type will be defined later

type ObjectEditorCallbackResult<T extends InnerGridCell> = {
    editor: ProvideEditorComponent<T>;
    deletedValue?: (toDelete: T) => T;
    styleOverride?: any; // Changed from CSSProperties to any
